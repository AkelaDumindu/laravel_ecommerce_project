<div class="bg-gray-100 shadow-sm rounded-lg hover:border border-green-400 p-1">
    <a href="/product/details">
        <div>
            <img src="{{ asset('images/1.jpg') }}" alt="product-image" class="rounded-t-lg object-cover w-full h-64">
        </div>
        <div>
            <h2 class="line-clamp-2 px-3">A plantation is a large farm...</h2>
            <div class="flex justify-between px-3 py-2">
                <div class="bg-green-200 p-1 rounded-md">
                    <h2 class="text-xl">Outfit</h2>
                </div>
                <h2 class="text-xl font-medium">Rs.50.00</h2>
            </div>
            <div class="px-3 py-1">
